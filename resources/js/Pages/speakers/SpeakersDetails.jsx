...
export default function SpeakersDetails() {
	...
	return (
		<div className='w-full flex justify-center items-center p-4 sm:p-6'>
			<div
				className={`flex flex-col md:flex-row gap-4 w-full sm:w-4/5 lg:w-3/5  items-start ${
					lang === 'ar' ? 'flex-row-reverse items-start' : ''
				}`}
			>
				{/* Image Section */}
				<div className='w-full md:w-1/3 flex justify-center items-center'>
					<img
						className='w-full h-48 md:h-64 lg:h-80 object-cover rounded-md'
				...
				<div className='w-full md:w-2/3 flex flex-col gap-4'>
					...
					<div className='flex justify-between items-center'>
						<p
							className={`text-gray-600 text-base sm:text-lg text-start   flex justify-center gap-1 items-start ${
								lang === 'ar' ? 'text-right' : 'text-left'
							}`}
						>
							<CgWorkAlt className='text-xl mt-1' />
						...
						>
							{' '}
							<AiOutlineGlobal className='text-xl  mt-1' />
							{lang === 'en'
